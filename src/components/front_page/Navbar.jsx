      ...
      featured: [
        {
          ...
          href: `${import.meta.env.VITE_API_FRONTEND}/products?category=sonic`,
          imageSrc:
        ...
        },
        {
          ...
          href: `${import.meta.env.VITE_API_FRONTEND}/products?category=marvel`,
      ...
      sections: [
        {
          ...
          name: 'Popular',
          items: [
            { name: 'Football (most popular)', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=football`, },
            { name: 'Stranger Things', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=stranger things`, },
            { name: 'Marvel', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=marvel`, },
          ],
        },
        {
          id: 'tv',
          name: 'TV',
          items: [
            { name: 'Star Wars', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=star wars`, },
            { name: 'Fantastic 4', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=marvel`, },
            { name: 'Teenage Mutant Ninja Turtles', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=tmnt`, },
            { name: 'Sonic', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=sonic`, },
            { name: 'Simpsons', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=simpsons`, },
          ],
        },
        {
          id: 'other',
          name: 'Other',
          items: [
            { name: 'Military', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=military`, },
            { name: 'Team GB', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=olympics`, },
            { name: 'Wednesday', href: `${import.meta.env.VITE_API_FRONTEND}/products?category=wednesday`, },
          ],
        },
      ],
    },
