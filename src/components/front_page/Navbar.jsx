  ...
  categories: [
    {
      ...
      featured: [
        {
          name: 'New Collection - Stranger Things',
          href: `/products?category=stranger things`,
          imageSrc: 'data:image/png;base64,',
          imageAlt: 'Drawstring top with elastic loop closure and textured interior padding.',
        },
        {
          name: 'Popular Figures - Marvel',
          href: `/products?category=marvel`,
      ...
      sections: [
        {
          ...
          name: 'Popular',
          items: [
            { name: 'Football (Most Popular)', href: `/products?category=football`, },
            { name: 'Stranger Things (New)', href: `/products?category=stranger things`, },
            { name: 'Marvel', href: `/products?category=marvel`, },
          ],
        },
        {
          id: 'tv',
          name: 'TV',
          items: [
            { name: 'Star Wars', href: `/products?category=star wars`, },
            { name: 'Fantastic 4', href: `/products?category=marvel`, },
            { name: 'Teenage Mutant Ninja Turtles', href: `/products?category=tmnt`, },
            { name: 'Sonic', href: `/products?category=sonic`, },
            { name: 'Simpsons', href: `/products?category=simpsons`, },
          ],
        },
        {
          id: 'other',
          name: 'Other',
          items: [
            { name: 'Military', href: `/products?category=military`, },
            { name: 'Team GB', href: `/products?category=olympics`, },
            { name: 'Wednesday', href: `/products?category=wednesday`, },
          ],
        },
      ],
    },
